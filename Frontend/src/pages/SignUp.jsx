...
function SignUp() {
    ...
    const signUp = async (data) => {
        console.log("submit")
        try {
            const response = await fetch('http://127.0.0.1:5500/auth/signup', {
                method: 'POST',
                headers: {
            ...
            if (response.status === 201) {
                ...
                toast.success("User successfully registered redirecting...", {
                                        ...
                                        {...register('fullName',
                                            {
                                                ...
                                                validate:
                                                {
                                                    minLength: (value) => value.length >= 2 || "The username should have at least 2 characters"
                                                }
                                            })
                                        }
                                    />
                                    {errors.fullName?.message && (<small className=' text-red-600'>{errors.fullName.message}</small>)}
                                </div>
                            </div>
                            <div>
